...
const hotelindex = () =>
    import ('../components/hotel/indexContent')
const homeShow = () =>
    import ('../components/hotel/home/homeShow')
const addHome = () =>
    import ('../components/hotel/home/addHome')
const userlive = () =>
    import ('../components/hotel/home/userlive')
const Reservelive = () =>
    import ('../components/hotel/home/Reservelive')
const liveList = () =>
    import ('../components/hotel/user/live')
const lenve = () =>
    import ('../components/hotel/user/lenve')
const viper = () =>
    import ('../components/hotel/vip/viper')
const addvip = () =>
    import ('../components/hotel/vip/addvip')
const fill = () =>
    import ('../components/hotel/finace/bill')
const tongji = () =>
    import ('@/components/hotel/finace/tongji')
const adminList = () =>
    import ('@/components/hotel/Administrators/list.vue')
const addAdmin = () =>
    import ('@/components/hotel/Administrators/addAdmin')
const purChange = () =>
    import ('@/components/hotel/Administrators/purChange')

//住宅相关页面
const home = () =>
    import ('@/components/home/homemenu')
const homeindex = () =>
    import ('@/components/home/index')
const personAdmin = () =>
    import ('@/components/home/liveAdmin/personAdmin')
const addliveperson = () =>
    import ('@/components/home/liveAdmin/addliveperson')
const personouser = () =>
    import ('@/components/home/ouser/personouser')
const caradmin = () =>
    import ('@/components/home/ouser/caradmin')
const real = () =>
    import ('@/components/home/videolist/Clue.vue')
const video_list = () =>
    import ('@/components/home/videolist/video_list.vue')
const video = () =>
    import ('@/components/home/videolist/video')
const videoed = () =>
    import ('@/components/home/videolist/videoed')
const video_list2 = () =>
    import ('@/components/home/videolist/video_list2')
const video_list3 = () =>
    import ('@/components/home/videolist/video_list3')
const video_list4 = () =>
    import ('@/components/home/videolist/video_list4')
const video_list5 = () =>
    import ('@/components/home/videolist/video_list5')
const video_list6 = () =>
    import ('@/components/home/videolist/video_list6')
const visteror = () =>
    import ('@/components/home/visteror/visteror')
const addCar = () =>
    import ('@/components/home/ouser/addCar')
const addPersonouser = () =>
    import ('@/components/home/ouser/addPersonouser')
const livecar = () =>
    import ('@/components/home/liveadmin/livecar');
const addlivecar = () =>
    import ('@/components/home/liveadmin/livecaradmin');

//商业街相关页面
const shopstreet_index = () =>
    import ('@/components/shopstreet/shopstreet_menu')
const shopstreethome = () =>
    import ('@/components/shopstreet/shopstreetHome')
const showstreet = () =>
    import ('@/components/shopstreet/showstreet')
const streetlist = () =>
    import ('@/components/shopstreet/streetlist')
const addshopstreet = () =>
    import ('@/components/shopstreet/addshopstreet')

const bannerlist = () =>
    import ('@/components/shopstreet/bannerlist')
const dataList = () =>
    import ('@/components/shopstreet/dataList')
const revenenue = () =>
    import ('@/components/shopstreet/revenenue')
const shop = () =>
    import ('@/components/shopstreet/shop')
const streetAdminList = () =>
    import ('@/components/shopstreet/Administrators/list')
const streetAddAdmin = () =>
    import ('@/components/shopstreet/Administrators/addAdmin')
const streetpurChange = () =>
    import ('@/components/shopstreet/Administrators/purChange')

const addBannerPosition = () =>
    import ('@/components/shopstreet/addBannerPosition')
const addBanner = () =>
    import ('@/components/shopstreet/addBanner')

//产业园相关页面
const Industrial = () =>
    import ('@/components/industrial/menu');
const Industrial_index = () =>
    import ('@/components/industrial/index')
const tenement = () =>
    import ('@/components/industrial/tenement')
const dot = () =>
    import ('@/components/industrial/dot')
const customer = () =>
    import ('@/components/industrial/customer')
const merchant = () =>
    import ('@/components/industrial/merchant')
const contractadmin = () =>
    import ('@/components/industrial/contractadmin')
const contractrev = () =>
    import ('@/components/industrial/contractrev')
const tobesubmit = () =>
    import ('@/components/industrial/tobesubmit')
const rentmgt = () =>
    import ('@/components/industrial/rentmgt')
const marginmgt = () =>
    import ('@/components/industrial/marginmgt')
const retirestt = () =>
    import ('@/components/industrial/retirestt')
const datachart = () =>
    import ('@/components/industrial/datachart')

//ppp项目相关页面
const pppMenu = () =>
    import ('@/components/pppproject/pppMenu')
const settledEnterprise = () =>
    import ('@/components/pppproject/settledEnterprise')
const projectDetail = () =>
    import ('@/components/pppproject/projectDetail')
const projectInvest = () =>
    import ('@/components/pppproject/investment')
const projectinvestment = () =>
    import ('@/components/pppproject/projectinvestment')
const bulletinText = () =>
    import ('@/components/pppproject/bulletinText')
const profitList = () =>
    import ('@/components/pppproject/profitlist')
const bulletin = () =>
    import ('@/components/pppproject/bulletin')
const consumptionlist = () =>
    import ('@/components/pppproject/consumptionlist')
const pppindex = () =>
    import ("@/components/pppproject/pppindex");
//城镇相关页面
const townMenu = () =>
    import ("@/components/town/town_menu")
const townIndex = () =>
    import ("@/components/town/town_index")
const towneast = () =>
    import ('@/components/town/town_east')
const towncenter = () =>
    import ('@/components/town/town_center')
const townnosth = () =>
    import ('@/components/town/town_nosth')
const townpersonAdmin = () =>
    import ('@/components/town/personAdmin');
const townliveAdmin = () =>
    import ('@/components/town/liveAdmin');
const towncasebar = () =>
