...
<!-- 表基本结构 -->
    <el-table-column 
      prop="name"
      label="楼宇名称" align="center"  height="600px">
    </el-table-column>
    <el-table-column
       prop="total"
      label="楼宇总面积" align="center">
    </el-table-column>
    <el-table-column
       prop="rented"
      label="已出租面积" align="center">
    </el-table-column>
    <el-table-column
       prop="lieIdle"
      label="闲置面积" align="center">
    </el-table-column>
    <el-table-column
       prop="ratio"
      label="出租率" align="center">
    </el-table-column>
