<template>
    ...
    <el-table-column
      ...
      label="项目金额" align="center">
    </el-table-column>
    <el-table-column
       prop="investmentfunc"
      label="合作方式" align="center">
    </el-table-column>
    <el-table-column
       prop="field"
      label="所属领域" align="center">
    </el-table-column>
    <el-table-column
       prop="creattime"
   ...
   <div v-if="block" class="laybox">
       ...
       <el-row class="subtitle">
           ...
           <el-col :span="20" class="proname" style="color:#999">&nbsp;&nbsp;{{ investmentname }}</el-col>
       ...
       <el-row class="subtitle">
           ...
           <el-col :span="24" class="laytexttitle">
              &nbsp;&nbsp;项目名称:<span>{{investmentname}}</span>
           </el-col>
           <el-col :span="12" class="laytexttitle">
               &nbsp;&nbsp;投资金额:<span>{{investmentmoney}}</span>
           </el-col>
            <el-col :span="12" class="laytexttitle">
               &nbsp;&nbsp;合作方式:<span>{{investmentfunc}}</span>
           </el-col>
             <el-col :span="24" class="laytexttitle">
               &nbsp;&nbsp;所属领域:<span> 自然资源</span>
           </el-col>
           <el-col :span="12" class="laytexttitle">
               &nbsp;&nbsp;项目资料:<span>{{projectstaic}}</span>
           </el-col>
          
            <el-col :span="24" class="laytexttitle">
               &nbsp;&nbsp;项目介绍:<span>{{projectsay}}</span>
           </el-col>
       </el-row>
...
export default {
    ...
    computed: {
        ...mapState({
         homeData: state => state.pppProject.investment,
         investmentname: state => state.pppProject.investmentname,
         investmentmoney: state => state.pppProject.investmentmoney,
         investmentfunc:state => state.pppProject.investmentfunc,
         projectstaic: state => state.pppProject.projectstaic,
         projectsay: state => state.pppProject.projectsay,
    ...
    methods: {
        ...
        this.$prompt('姓名', '修改提示', {
          ...
          cancelButtonText: '取消',
            ...
            this.$store.commit('setinvestment',{
              num:callmessage,
              storevalue:value,
              page : this.page
            })
          ...
          deleteData(callmessage){
            this.$alert('确定删除么','网页提示',{
                confirmButtonText: '删除',
                 ...
                 this.$store.commit('deleteDatainvestment',{
                    num:callmessage,
                    page : this.page,
        ...
        see(message){
            ...
            this.$store.commit('showinvestment',{
                page:this.page,
                message:message,
            })
        },
