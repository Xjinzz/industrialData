<template>
    ...
    <el-table-column 
      prop="investmentname"
      label="投资机构" align="center" width="250px">
    </el-table-column>
    <el-table-column
       prop="investmentmoney"
      label="投资额" align="center">
    </el-table-column>
    <el-table-column
       prop="investmentfunc"
      label="投资方式" align="center">
    </el-table-column>
    <el-table-column
       prop="exitfunc"
      label="退出方式" align="center">
    </el-table-column>
    <el-table-column
       prop="investmentpreson"
      label="投资人" align="center">
    </el-table-column>
    <el-table-column
       prop="investmentage"
      label="投资年限" align="center">
    </el-table-column>
    <el-table-column
       prop="money"
      label="收益额" align="center">
    </el-table-column>
    <el-table-column
       prop="st"
      label="操作"
