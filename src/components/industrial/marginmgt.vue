<template>
    ...
    :show-header="true"
    border
    style="width: 100%;height:800px;margin-top:0px;">
    <el-table-column 
      prop="num"
    ...
    <el-table-column
       prop="money"
      label="收租金额" align="center">
    </el-table-column>
    <el-table-column
       prop="static"
      label="状态" align="center">
        <template slot-scope="scope">
            <el-col style="color:#999;font-size:18px;line-height:38px;">已收租</el-col>
        </template>
    </el-table-column>
...
export default {
    ...
    computed: {
        ...mapState({
         homeData: state => state.marginmgt,
