<template>
    ...
    <div>
        ...
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" text-color="#666666" open="all">
            <el-col :span="23" :offset="1" class="pagetitle">合同审核</el-col>
            <el-menu-item index="all" >全部</el-menu-item>
            <el-menu-item :index="todata|dataFormat|tongguo">审核过合同</el-menu-item>
            <el-menu-item :index="todata|dataFormat|weitong">审核未通过合同</el-menu-item>
        </el-menu>
        <el-row :span="24">
            <el-col :span="8" style ="text-align:center">
             ...
             <el-col :span="8" style ="text-align:center">
                      <p class="contentTitle">审核通过合同总计</p>
                      <div class="homesnum">329个</div>
            </el-col>
             <el-col :span="8" style ="text-align:center">
                      <p class="contentTitle">审核未通过</p>
  ...
  <el-table-column
    ...
    <el-table-column
      ...
      <template slot-scope="scope">
        <el-button @click="see(scope.row)" type="text" size="small">详情</el-button>
...
export default {
    computed: mapState({
         homeData: state => state.contractrev
    }),
      data() {
      return {
        activeIndex: 'all',
    ...
    methods: {
      ...
      handleSelect(key, keyPath) {
        ...
        }else if(key.includes('未通过')){

           this.middleData=this.homeData.filter(item=>{
             if(item.static.includes('未通过')){
                  return true;
             }else{
               return false;
             }
